...
//$xIDExpe=98261;
$sql="SELECT * FROM colaboradores where tipo=0 and activo='SI' and (interno='NO' or interno='no')";
...
function Header()
{
	...
	$this->Cell(70);
	//Título
	$this->Cell(10,30,'Gestores activos externos a fecha de: '.date("d/m/y"));
	//Salto de línea
	$this->Ln(20);
...
function FancyTable($header, $stid)
{
	...
	//Cabecera
	$w=array(15,45,15,42,40,27,10,15,15,15,15,15);
