...
{	var Oficina=document.getElementById('xOficina').value;
	...
	var Oficina=document.getElementById('xOficina').value;
	var url_parametros="xOficina="+Oficina+"&xNot="+oCelda.innerHTML;
	//alert(url_parametros);
	location="Redmoon_php/ORAModNotarioHabitual.php?"+url_parametros;
...
<h4 align="center" class="Estilo1">Selecci&oacute;n de Notario Habitual</h4>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
...
<input type="hidden" name="xOficina" id="xOficina" value="<?php echo  $_GET["xOficina"];?>"/>
