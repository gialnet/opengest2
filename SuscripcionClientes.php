...
<title>Suscripciones Clientes</title>
...
<h3 align="center" class="Estilo5">Suscripción Demandantes de Oferta Inmobiliaria</h3>
...
<form id="form1" name="form1" method="post" action="">
  ...
  <label><span class="Estilo5">E-mail</span>
  ...
  <p>
    ...
    <br/>
     <br/>
    <label>
    <input type="checkbox" name="inFinanciacion" id="inFinanciacion" />
   <span class="Estilo5"> ¿Necesita financiación para la compra?</span></label>
  </p>
  <p>
