	...
	for(x=0; x<=ArrayColumnas.length-2; x+=6)
	    {
			...
			'<img src="redmoon_img/imgTablas/editar.png" onclick="chgProvision('+j+',this.id)" id="oChgPosicion'+j+'">';
...
<div id="rastro"><a href="MenuAdmin.php">Inicio</a> >
    <a href="TablaOficinasGestores.php">Lista de Oficinas</a> >
    Gestores de la Oficina
...
<table width="750" border="0" id="oTabla">
  <tr bgcolor="#C6DFEC" id="oFila0" style="color:#3C4963; cursor:default">
    ...
    <td width="16%"><strong>Poblaci&oacute;n</strong></td>
     <td width="10%"><strong>Posici&oacute;n</strong></td>
