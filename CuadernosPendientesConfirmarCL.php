...
$xPendientes='P';
$sql="SELECT id,fecha,ruta  FROM CUADERNO34 WHERE ENVIADO_BE=:xPendientes and tipo='CL'";
...
function GetFila(xID)
{
	...
	{
		url='Redmoon_php/Cuaderno34enviadoCL.php';
...
<div id="rastro"><a href="MenuLGS.php">Inicio</a> >
       <a href="PagosAClientes.php">Pagos a Colaboradores</a> >
