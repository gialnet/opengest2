...
$sql = "select sum(e.cuantia)/1000 as Importe,  to_char(e.fecha_apertura,'YYYY') as anio 
	...
	where e.ne= s.ne AND s.sujeto='T' and substr(s.NIF_CLIENTE,1,1)='Q'
...
//$title = new title( 'Importe de las solicitudes de organismos publicos por anios');
