...
$sql = "select sum(e.cuantia)/1000000 as Importe,  to_char(e.fecha_apertura,'YYYY') as anio 
	from expedientes e, CLIENTES_EXPE s
	where e.ne= s.ne and s.sujeto='T' and substr(s.NIF_CLIENTE,1,1) in ('A','B','C','D','F','U')
...
//$title = new title( 'Importe de las solicitudes de empresas por anios');
...
$y = new y_axis();
$y->set_range( 0, 4000,500 );
$chart->set_y_axis( $y );



//leyenda del eje y
$y_legend = new y_legend( 'En millones de euros' );
