...
$sql = "select sum(cuantia)/1000000 as importe,  to_char(fecha_apertura,'YYYY') as anio from expedientes where
to_char(fecha_apertura,'YYYY')>=:xANIOS
...
//$title = new title( 'Importe de las solicitudes por A&ntilde;os');
