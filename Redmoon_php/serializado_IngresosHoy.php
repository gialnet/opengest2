...
do_queryTodo($conn, 'SELECT ID,NE,DESCRIPCION,FECHA_MOVIMIENTO,IMPORTE FROM VWINGRESOS_HOY');
...
if (!isset($_POST['xPag']))
	...
	$suma=$suma.$resultado[$j]['FECHA_MOVIMIENTO'].'|';
...
$url='serializado_IngresosHoy.php';
$opcion='Ingresos realizados a dia de hoy';
