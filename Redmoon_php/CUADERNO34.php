...
//
// Generar fichero de texto con el formato C34 Consejo Superior Bancario Español.
//
...
//
// Poner un número determinado de espacios en blanco en el fichero.
//
...
$conn = db_connect();
	...
	//
	// Datos del beneficiario y de la cuenta del beneficiario, esta cuenta puede variar en función del
...
// $xIDCuaderno es pasado por referencia para que nos devuelva el valor en la función do_save_oracle
