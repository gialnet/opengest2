...
<title>Facturacion Deudor</title>
...
function LeeConsulta(Opcion)
{
	...
	PutDataAsuntos('Redmoon_php/serializado_FacturacionCierreDeudor.php', url_parametros);
}
//
...
<div id="documento">
    <div id="rastro"><a href="MenuLGS.php">Inicio</a>
         > Expedientes Finalizados con Saldo Deudor
    </div>
    <div id="ayuda_btn">
		<!--<img src="Redmoon_img/imgDoc/ayuda.png" alt="Ayuda" title="Ayuda" onclick="AbrirAyuda('Gestoria_documentacion/expediente_termiandos_con_saldo_deudor.html')" />-->
	</div>
...
<table width="780" border="0" id="oTabla">
  <tr bgcolor="#C6DFEC" id="oFila0" style="color:#3C4963; cursor:default">
    <td width="8%"><strong>NE</strong></td>
    <td width="10%"><strong>NIF</strong></td>
    <td width="40%"><strong>Nombre</strong></td>
    <td width="15%" align="center" ><strong>Cuantia</strong></td>
    <td width="12%" align="center" ><strong>Provision</strong></td>
    <td width="15%" align="center" ><strong>SALDO</strong></td>
  </tr>
</table>
