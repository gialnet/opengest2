...
<title>Tipos de Expedientes</title>
...
function GetFila(xID)
{
	...
	document.getElementById('ModTipo').style.visibility='visible';
	document.getElementById('modtipo').value=oCelda.innerHTML;
	//location="Notarios.php?xIDNotario="+oCelda.innerHTML;
	var xTipo=document.getElementById(xID).cells[0];
	document.getElementById('xIDtipo').value=xTipo.innerHTML;
...
<table width="400"  border="0" id="oTabla">
  <tr bgcolor="#C6DFEC" id="oFila0" style="color:#3C4963; cursor:default">
    ...
    <td width="90%"><strong>Tipo de Expediente</strong></td>
...
<p class="Estilo1">Introduzca el nuevo tipo de Expediente:</p>
...
<p class="Estilo1">Modifique el tipo de Expediente:</p>
