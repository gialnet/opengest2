...
function LeeConsulta()
{
	...
	PutDataAsuntos('Redmoon_php/serializado_PagosAClientes.php',url_parametros);
}
//
//
//
		...
		if (pageRequest.status==200)
		{
			...
			else
			{
				...
				if(cadena=='Cuaderno34 generado'){
					...
					location='Redmoon_php/subirNubeCuaderno34.php?xTipo=clientes';
				}
...
function LlamarPago(){
	...
	url='Redmoon_php/CUADERNO34Clientes.php';
...
function CuadernosPendientes(){
	location='CuadernosPendientesConfirmarCL.php';
}
...
<div id="ayuda_btn">
		<!--<img src="Redmoon_img/imgDoc/ayuda.png" alt="Ayuda" title="Ayuda" onclick="AbrirAyuda('Gestoria_documentacion/gestion_cuaderno_pago_clientes.html')" />-->
</div>
<div id="btnPaginaB">
...
<h4  class="Estilo1">Cuaderno de Pago a Clientes</h4>
<div id="imagenCuaderno">
 <img src="Redmoon_img/imgDoc/pagoOFF.png" alt="Generar cuaderno de Pago" title="Generar Cuaderno de Pago" onclick="LlamarPago()" />
</div>
