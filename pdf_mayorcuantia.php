...
//$xIDExpe=98261;
$sql='SELECT NE,NIF,APENOMBRE,CUANTIA,IMP_PROVISION,IMP_GESTION FROM VWMAYOR_CUANTIA';
...
function Header()
{
	...
	$this->Cell(70);
	//Título
	$this->Cell(10,30,'Expedientes de Mayor Cuantía a fecha de:'.date("d/m/y"));
	$this->Cell(150);
...
while ($row = oci_fetch_array($stid, OCI_ASSOC+OCI_RETURN_NULLS)) 
	{
		...
		$this->Cell($w[4],8,number_format($row['IMP_GESTION']).' €','LR',0,'L',$fill);
